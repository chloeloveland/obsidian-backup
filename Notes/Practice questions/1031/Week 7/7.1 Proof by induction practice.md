...
4. 
	1. By definition of addition and multiplication (distribution) know that $3\times((k+1)+2) = 3k+9$
	2. By definition of addition and multiplication (distribution) know that $(3\times (k +1)) + 6 = 3k + 9$
	3. from 3) and 4) know that $3\times ((k+1)+2) = (3\times (k+1)) + 6$ holds.